...
class AnyValidator extends Validator {
	...
	default(value) {
		if (!(value instanceof Type.Null ||
			...
			throw new SchemaError('Expected value to be one of [Null, Boolean, Number, String, Array, Object]');
	...
	parseSync(data) {
		try {
			if (!(data instanceof Type.Boolean ||
				...
				throw new ParseError('Expected value to be one of [Boolean, Number, String, Array, Object]');
